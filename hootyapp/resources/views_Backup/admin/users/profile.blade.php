                ...
                <section class="panel">
                    <div class="avatar-slide">
                        ...
                        <div class="avatar-link btn-group btn-group-justified">
                            <table width="100%">
                                <tr>
                                    <td data-id="{{$profile->id}}">
                                        <a class="btn  active_btn active_btn_{{$profile->id}} @if($profile->user_status == 1) display_non @endif"
                                            href="#" title="Active" style="width: 100%">Active</a>
                                        <a class="btn block_btn block_btn_{{$profile->id}} @if($profile->user_status != 1) display_non @endif href="
                                            #" title="Block" style="width: 100%">Block</a>
                                    </td>
                                </tr>
                            </table>
                        </div>
