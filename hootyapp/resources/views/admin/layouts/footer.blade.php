<div id="md-notification" class="modal fade md-stickTop bg-danger" tabindex="-1" data-width="500">
    ...
    <nav id="menu">
        <ul>
            <li><a href="{{URL::route('admin_home')}}"><i class="icon  fa fa-inbox"></i> Dashboard</a></li>
            <li><a href="{{URL::route('admin_JournaList')}}"><i class="icon  fa fa-users"></i> Journalist</a></li>
            <li><a href="{{URL::route('admin_user')}}"><i class="icon  fa fa-users"></i> Users</a></li>
            <li><a href="{{URL::route('admin_message_user')}}"><i class="icon  fa fa-comments"></i> Message</a></li>
