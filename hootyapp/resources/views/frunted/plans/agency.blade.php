...
<div class="stage" id="stage">
	<div class="block block-inverse block-fill-height app-header"
		...
		<h2 class="text-center">Agency Plan Payment $400</h2>
		<div class="container payment_card col-md-6">
			<form action="{{URL::route('pay_with_agency')}}" method="post" class="row">
				{{ csrf_field() }}
				<div class="col-md-12">
					<label>Card Number</label>
					<div class="input-group{{ $errors->has('card_no') ? ' has-error' : '' }}">
						<input type="text" name="card_no" value="{{ old('card_no') }}" class="form-control" id="card_no"
				...
				<div class="col-md-6">
					<div class="form-group {{ $errors->has('ccExpiryMonth') ? ' has-error' : '' }}">
						...
						<input type="text" name="ccExpiryMonth" id="ccExpiryMonth" class="form-control"
							placeholder="mm">
					</div>
				...
				<div class="col-md-12 text-center">
					<br>
					<button type="submit" class="btn btn-success make-payment">Make Payment</button>
				</div>
			</form>
		</div>
	</div>
